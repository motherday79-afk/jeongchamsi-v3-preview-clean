...
2. Extract `JCV3_HISTORY_V2_POLITICAL_INTELLIGENCE_PATCH_20260829.zip` at the project root and overwrite matching files.
...
5. Select one National Assembly member, one metropolitan mayor/governor, and one basic local-government head and open HISTORY.
