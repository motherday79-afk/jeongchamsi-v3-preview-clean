...
assert.match(index, /03682-main-live-pulse/, 'index cache marker가 03682로 갱신되어야 합니다');
assert.match(app, /\.\/views\/home\.js\?v=03682/, '동적 home.js import도 03682로 cache-bust 해야 합니다');
