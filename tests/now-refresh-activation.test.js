...
assert(route.includes('missingEnv'),'route must expose missing environment variable names');
assert(app.includes('missingConfig'),'client must preserve missing config details');
