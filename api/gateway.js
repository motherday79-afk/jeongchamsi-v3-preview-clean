...
const routeLoaders = Object.freeze({
  ...
  "politician-photo": () => require("../server/v3/routes/politician-photo"),
  "politician-live-data": () => require("../server/v3/routes/politician-live-data"),
  "partners": () => require("../server/v3/routes/partners"),
  "content": () => require("../server/v3/routes/content"),
  "home": () => require("../server/v3/routes/home"),
  "now-data": () => require("../server/v3/routes/now-data"),
  ...
  "admin/badges": () => require("../server/v3/routes/admin/badges"),
  "admin/dashboard": () => require("../server/v3/routes/admin/dashboard"),
  "admin/now-data": () => require("../server/v3/routes/admin/now-data"),
  "admin/history": () => require("../server/v3/routes/admin/" + "history"),
  "user/activity": () => require("../server/v3/routes/user/activity"),
  "user/badges": () => require("../server/v3/routes/user/badges"),
