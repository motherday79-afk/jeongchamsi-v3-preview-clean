...
async function resolveView(state) {
  ...
  if (!p.length) return (await import("./views/home.js?v=alpha6.0.32-art-direction-2")).renderHome();
  ...
  return (await import("./views/home.js?v=alpha6.0.32-art-direction-2")).renderHome();
}
