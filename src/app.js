...
async function resolveView(state) {
  ...
  if (!p.length) return (await import("./views/home.js?v=alpha6.0.36.10-generation-refine")).renderHome();
  ...
  return (await import("./views/home.js?v=alpha6.0.36.10-generation-refine")).renderHome();
}
