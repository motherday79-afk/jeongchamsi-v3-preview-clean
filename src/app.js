...
async function resolveView(state) {
  ...
  if (!p.length) return (await import("./views/home.js?v=alpha6.0.36.6-dom-order-rootfix")).renderHome();
  ...
  return (await import("./views/home.js?v=alpha6.0.36.6-dom-order-rootfix")).renderHome();
}
