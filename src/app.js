...
async function resolveView(state) {
  ...
  if (p[0] === "person") return (await import("./views/people.js?v=03686-history-v2-observation-count-jcs-political-intelligence-source-layer-v2-strategic-solution-v1-validity-perf-v1-signal-confidence-v1-age-gender-v2-ui-visible-admin-premium-intelligence-v2")).renderPersonDetail(p[1] || "");
  ...
  const view = await import("./views/features.js?v=03686-jcs-share-v1-admin-multi-compare-inforeghini-jcs-clean-rebuild-r1-admin-premium-intelligence-v2");
...
async function render(state = currentRoute(), { resetScroll = true, scrollTarget = null } = {}) {
  ...
  if (app.querySelector("[data-person-admin-intelligence-slot]")) {
    requestAnimationFrame(() => {
      import("./views/people.js?v=03686-history-v2-observation-count-jcs-political-intelligence-source-layer-v2-strategic-solution-v1-validity-perf-v1-signal-confidence-v1-age-gender-v2-admin-premium-intelligence-v2")
...
document.addEventListener("click", async event => {
  ...
  if (nowMore) {
    ...
    const tools = await import("./views/features.js?v=03686-jcs-share-v1-admin-multi-compare-inforeghini-jcs-clean-rebuild-r1-admin-premium-intelligence-v2");
...
document.addEventListener("change", async event => {
  ...
  if (adminCompareAdd && adminCompareAdd.value) {
    ...
    const query=new URLSearchParams();ids.forEach(id=>query.append('p',id));
    import("./core/instant-prefetch.js?v=admin-multi-compare-inforeghini-admin-premium-intelligence-v2").then(({prefetchCompareSelection})=>prefetchCompareSelection(ids)).catch(()=>{});
