...
async function resolveView(state) {
  ...
  if (!p.length) return (await import("./views/home.js?v=alpha6.0.36.8-nav-itsme")).renderHome();
  ...
  return (await import("./views/home.js?v=alpha6.0.36.8-nav-itsme")).renderHome();
}
