...
async function resolveView(state) {
  ...
  if (!p.length) return (await import("./views/home.js?v=alpha6.0.36.5.1-home-order-cachefix")).renderHome();
  ...
  return (await import("./views/home.js?v=alpha6.0.36.5.1-home-order-cachefix")).renderHome();
}
