...
function pollMarkup(poll) {
  ...
  return `<div class="poll-main"><div class="poll-question"><span class="poll-status">진행중</span><h3>${esc(poll.question)}</h3><p>정참시 참여자 기반 설문 · ${total.toLocaleString("ko-KR")}표</p></div><div class="poll-options">${optionMarkup}</div></div>`;
}
  ...
  return `<div class="site-shell">
    ...
    <div class="page-wrap"><div class="portal-layout">
      ...
      <main class="main-column">
        ...
        <section class="module" id="itsme"><div class="module-header"><div><span class="eyebrow">IT’S ME</span><h2>정치 속의 나를 발견하세요</h2><p class="module-desc">참여형 기능을 한 묶음으로 보여주는 개인화 영역.</p></div><button class="more-btn" type="button" data-go="/itsme">IT’S ME 전체보기 →</button></div><div class="itsme-grid"><article class="itsme-card"><span>01</span><b>나의 정치성향</b><p>개인 정치성향 기능 영역</p></article><article class="itsme-card"><span>02</span><b>나와 가까운 정치인</b><p>정치인 매칭 기능 영역</p></article><article class="itsme-card"><span>03</span><b>내 지역 정치</b><p>지역 정치정보 기능 영역</p></article><article class="itsme-card"><span>04</span><b>내가 국회의원이라면</b><p>정책 제안 기능 영역</p></article><article class="itsme-card"><span>05</span><b>오늘의 정치 질문</b><p>짧은 참여 기능 영역</p></article><article class="itsme-card accent"><span>06</span><b>IT’S ME 시작</b><p>정치 속의 나를 발견합니다.</p></article></div></section>
