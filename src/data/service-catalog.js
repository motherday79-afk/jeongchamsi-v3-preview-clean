export const SERVICE_CATALOG = Object.freeze([
  { key:"now", tone:"blue", label:"NOW Rank", shortLabel:"NOW Rank", description:"지금 가장 주목받는 정치인", href:"/now", launcher:true, serviceBar:true, group:"정치 보기" },
  ...
  { key:"trending", tone:"blue", label:"실시간 급상승 정치인", shortLabel:"급상승", description:"주목도가 빠르게 오른 정치인", href:"/trending", launcher:false, serviceBar:false, group:"정치 보기" }
]);
