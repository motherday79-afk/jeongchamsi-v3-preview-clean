const ADAPTER_REVISION = 'JCV3_NOW_STORAGE_SAFE_20260830_R1';
...
module.exports = {
  ADAPTER_REVISION, config, command, pipeline, health, getJSON, setJSON, mgetJSON, mgetRawJSON, msetJSON, scanDomains, deleteDomains,
