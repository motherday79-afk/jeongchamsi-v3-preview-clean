...
function applyFallbacks(person,search,news,previousView=null,nowMs=Date.now()){
  return {search:needsFallback(search)?modeledSearch(person,previousView):search,news:needsFallback(news)?modeledNews(person,previousView,nowMs):news};
}
module.exports={hashInt,modeledSearch,modeledNews,needsFallback,applyFallbacks};
