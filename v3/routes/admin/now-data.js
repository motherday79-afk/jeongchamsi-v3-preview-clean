...
const naverNews = require('../../lib/naver-news');
const newsCredentials = naverNews.credentials;
const newsAvailability = typeof naverNews.availability === 'function'
  ? naverNews.availability
  : () => { const c = newsCredentials(); return { available: Boolean(c?.configured), provider: 'naver-news' }; };
